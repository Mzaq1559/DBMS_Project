...
(1,'Suzuki','Cultus',2021,'VIN0000000000003','economy',4000.00),
(1,'Suzuki','Alto',2022,'VIN0000000000004','economy',3500.00),
(1,'Toyota','Yaris',2023,'VIN0000000000005','economy',5200.00),
(1,'Honda','Civic',2023,'VIN0000000000006','economy',6000.00),
(1,'Kia','Picanto',2022,'VIN0000000000007','economy',4500.00),
(1,'Hyundai','Tucson',2022,'VIN0000000000008','suv',9000.00),
(1,'Toyota','Fortuner',2023,'VIN0000000000009','suv',12000.00),
(1,'Kia','Sportage',2023,'VIN0000000000010','suv',10000.00),
(2,'Toyota','Corolla',2021,'VIN0000000000011','economy',4800.00),
(2,'Honda','City',2022,'VIN0000000000012','economy',5200.00),
(2,'Suzuki','Cultus',2022,'VIN0000000000013','economy',4000.00),
(2,'Toyota','Yaris',2022,'VIN0000000000014','economy',5000.00),
(2,'Honda','Civic',2022,'VIN0000000000015','economy',5800.00),
(2,'Kia','Picanto',2023,'VIN0000000000016','economy',4600.00),
(2,'Suzuki','Swift',2023,'VIN0000000000017','economy',4200.00),
(2,'Hyundai','Tucson',2023,'VIN0000000000018','suv',9500.00),
(2,'Toyota','Fortuner',2022,'VIN0000000000019','suv',11500.00),
(2,'Kia','Sportage',2022,'VIN0000000000020','suv',9800.00),
(2,'MG','HS',2023,'VIN0000000000021','suv',11000.00),
(2,'Toyota','Land Cruiser',2022,'VIN0000000000022','suv',20000.00),
(2,'Honda','BRV',2023,'VIN0000000000023','suv',8500.00),
(2,'Toyota','Camry',2023,'VIN0000000000024','luxury',15000.00),
(2,'Honda','Accord',2022,'VIN0000000000025','luxury',14000.00),
(3,'Toyota','Corolla',2023,'VIN0000000000026','economy',5100.00),
(3,'Honda','City',2023,'VIN0000000000027','economy',5400.00),
(3,'Suzuki','Cultus',2023,'VIN0000000000028','economy',4100.00),
(3,'Toyota','Yaris',2023,'VIN0000000000029','economy',5100.00),
(3,'Honda','Civic',2023,'VIN0000000000030','economy',6100.00),
(3,'Kia','Picanto',2022,'VIN0000000000031','economy',4400.00),
(3,'Suzuki','Alto',2023,'VIN0000000000032','economy',3600.00),
(3,'Suzuki','Swift',2022,'VIN0000000000033','economy',4300.00),
(3,'Hyundai','Tucson',2022,'VIN0000000000034','suv',9200.00),
(3,'Toyota','Fortuner',2023,'VIN0000000000035','suv',12500.00),
(3,'Kia','Sportage',2023,'VIN0000000000036','suv',10500.00),
(3,'MG','HS',2022,'VIN0000000000037','suv',10800.00),
(3,'Toyota','Land Cruiser',2023,'VIN0000000000038','suv',21000.00),
(3,'Honda','BRV',2022,'VIN0000000000039','suv',8200.00),
(3,'Toyota','Camry',2022,'VIN0000000000040','luxury',14500.00),
(3,'Honda','Accord',2023,'VIN0000000000041','luxury',14500.00),
(1,'MG','HS',2023,'VIN0000000000042','suv',11200.00),
(1,'Toyota','Land Cruiser',2023,'VIN0000000000043','suv',21500.00),
(1,'Honda','BRV',2023,'VIN0000000000044','suv',8700.00),
(1,'Toyota','Camry',2023,'VIN0000000000045','luxury',15500.00),
(1,'Honda','Accord',2023,'VIN0000000000046','luxury',14800.00),
(1,'Suzuki','Swift',2023,'VIN0000000000047','economy',4400.00),
(2,'Suzuki','Alto',2023,'VIN0000000000048','economy',3700.00),
(1,'Changan','Alsvin',2023,'VIN0000000000049','economy',4600.00),
(2,'Changan','Alsvin',2022,'VIN0000000000050','economy',4400.00);
GO
...
-- Reservations + Invoices (500) using T-SQL loop
DECLARE @v_id INT = 1;
DECLARE @i INT;
DECLARE @c_id INT;
DECLARE @s_date DATE;
...
BEGIN
    ...
    WHILE @i <= 10
    BEGIN
        SET @c_id  = ((@v_id * 7 + @i * 13) % 100) + 1;
        SET @days  = 2 + (@i % 5);
        SET @s_date = DATEADD(DAY, @offset,       '2024-01-01');
        SET @e_date = DATEADD(DAY, @days, @s_date);
        SET @offset = @offset + @days + 1;

        SELECT @rate = daily_rate FROM vehicles WHERE vehicle_id = @v_id;
...
PRINT 'Seed complete: 100 customers, 50 vehicles, 500 reservations';